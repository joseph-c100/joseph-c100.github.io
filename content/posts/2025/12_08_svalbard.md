...
Worked on sourcing geographic data for the map and building the initial version in QGIS before handing over to be built in illustrator. I then worked on animating the map using Svelte scroller.
